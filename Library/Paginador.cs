    ...
    public class Paginador<T>
    {
        ...
        public object[] paginador(List<T> table, int pagina, String area, String controller, String action, String host)
        {
            ...
            if (pagi_actual < pagi_totalPags)
            {
                ...
                pagi_navegacion += "<a id='paginas1' href='" + host + "/" + controller + "/" + action + "?id=" + pagi_url + "&area=" + area + "'>" + pagi_nav_siguiente + "</a>";
                ...
                pagi_navegacion += "<a  href='" + host + "/" + controller + "/" + action + "?id=" + pagi_url + "&area=" + area + "'>" + pagi_nav_ultima + "</a>";
            }
            /* 
           ...
           */
            ...
            String pagi_info = " del <b>" + pagi_desde + "</b> al <b>" + pagi_hasta + "</b> de <b>" + pagi_totalReg+ "</b>";
